...
<?php $inventory = $connect -> ViewSales(); ?>
<?php
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form method="POST" class="form-search">
								<button class="btn btn-xs btn-success" name="export_sales">
									Export Sales to CSV
								</button>
							</form>
						</div>
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td class="hidden-480">
														<center>
															<?php echo $view['prod_qty'];?>
														</center>
													</td>
													<td>
														&#8369; <?php echo number_format($view['total_price_remaining_stock']) ?>
													</td>
													<td class="hidden-480">
														<?php echo $view['sold_stock'];?>
													</td>				
													<td class="hidden-480">
														&#8369; <?php echo number_format($view['total_price_sold_stock'])?>
													</td>					
													<td>
														<tr><?php echo $view['total_price_remaining_stock'];?></tr>
													</td>												
												</tr>
												<?php } } else {?>
												<tr>
