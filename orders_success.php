...
<?php $pendings = $connect -> ViewAllSuccess(); ?>
<?php $sales = $connect -> TotalSales();?>
<?php
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Successful Orders</li>
						</ul><!-- /.breadcrumb -->

						
						<div class="nav-search" id="nav-search">
							<form class="form-search" method="POST">
								<button class="btn btn-success btn-xs" name="export_success">
									Export to CSV
								</button>
							</form>
						</div>
										...
										<table id="simple-table" class="table  table-bordered table-hover table">
											...
											<tbody>
												...
												if(mysqli_num_rows($pendings) > 0){ 
													while($view = mysqli_fetch_assoc($pendings)) { ?>
												<tr>
													<td><?php echo $view['prod_name']; ?>
													</td>
													<td>&#8369; <?php echo number_format($view['prod_price'], 2); ?></td>
													<td class="hidden-480">
														<?php echo $view['order_qty'];?>
													</td>
													<td>&#8369; <?php echo number_format($view['total_price'], 2); ?></td>
													<td class="hidden-480">
														<?php echo $view['customer_name'] ?>
													</td>
													<td><?php echo $view['customer_address']; ?></td>				
													<td align="center">
														<span class="label label-sm label-success"><?php echo $view['status']; ?>
														</span>
													</td>
													<td align="center">
														<?php echo $view['delivery_date'];?>
													</td>
													<td>
														<center>
															<?php echo $view['confirmed_by']; ?>
														</center>
													</td>
													<td>
														<center>
															<?php echo $view['confirmed_date']; ?>
