...
<?php $pendings = $connect -> ViewAllPendings(); ?>
<?php
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td align="center">
														<span class="label label-sm label-warning"><?php echo $view['status']; ?>
														</span>
													</td>
													<td align="center">
														<a href="confirm_orders.php?id=<?php echo $view['order_id']; ?>" class="btn btn-xs btn-primary">
															Confirm&nbsp;
