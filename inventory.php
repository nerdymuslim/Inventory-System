...
<?php $inventory = $connect -> ViewInventory(); ?>
<?php
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form method="POST" class="form-search">
								<button class="btn btn-xs btn-success" name="export_inventory">
									Export to CSV
								</button>
							</form>
						</div>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									No. of Outbound and Inbound Stocks
								</small>
							</h1>
						</div><!-- /.page-header -->
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													<th>Product</th>
													<th>Price</th>
													<th class="hidden-480">Quantity Added/Deducted</th>
											...
											<tbody>
												...
												<tr>
													...
													<td class="hidden-480">
														<center>
															<?php echo $view['inv_qty'];?>
														</center>
													</td>
													<td class="hidden-480">
														<?php if($view['status'] == "Added Stocks"){?>
														<span class="label label-sm label-success"><?php echo $view['status'] ?></span>
														<?php } elseif($view['status'] == "Deduct Stocks") { ?>
														<span class="label label-sm label-danger"><?php echo $view['status'] ?></span>
														<?php } else { ?>
														<span class="label label-sm label-warning">
														<?php echo $view['status'] ?></span>	
														</span>
														<?php } ?>
													</td>				
													<td>
														<?php echo $view['admin_name']; ?>
													</td>
													<td>
														<?php echo $view['date_added']; ?>
													</td>
												</tr>
												<?php } } else {?>
												<tr>
